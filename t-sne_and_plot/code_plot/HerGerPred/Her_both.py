...
data = pd.read_csv('/mnt/disk1/xyzhou/7.16code_plot/HerGerPred/Her.csv')
...
scatter_fig.savefig('/mnt/disk1/xyzhou/7.16code_plot/HerGerPred/Her_orange_both.png', dpi = 400)
#plt.show()
