...
data = pd.read_csv('/mnt/disk1/xyzhou/7.16code_plot/RoataE_file/Ro_out1.csv')
...
scatter_fig.savefig('/mnt/disk1/xyzhou/7.16code_plot/RoataE_png_file/Ro_orange_5_gene.png', dpi = 400)
#plt.show()
